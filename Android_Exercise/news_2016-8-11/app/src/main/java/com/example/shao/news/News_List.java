...
public class News_List extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    private void requeset () {
        Request<String> request = NoHttp.createStringRequest(url);//定义请求列表
        //向列表添加参数
        request.add("id","");
        request.add("addtime","");
        request.add("thumb","");
    ...
    private OnResponseListener<String> listener = new OnResponseListener<String>() {
        ...
        public void onStart(int what) {
            Toast.makeText(News_List.this,"开始请求",Toast.LENGTH_SHORT).show();
        }
...
//            String s = aNew.getThumb();
//            try {
//                new Thread(new Runnable() {
//                    @Override
//                    public void run() {
//                        bitmap1[i] = (Bitmap)ToBitmap.toBitmap(aNew.getThumb());
//                        aNew.setBitmap(bitmap1[i]);
//                    }
//                }).start();
//            }catch (Exception e) {
//                e.printStackTrace();
//                Log.d("News_List","ERRRRRRRRRRRRRRRRR"+ bitmap1[0] +" "+ s);
//            }
